...
def _migrate():
    ...
    migrations = [
        ...
        "ALTER TABLE voice_chat_sessions ADD COLUMN IF NOT EXISTS current_duration INTEGER",
        "ALTER TABLE voice_chat_sessions ADD COLUMN IF NOT EXISTS started_at TIMESTAMP",
        "ALTER TABLE users ALTER COLUMN user_id TYPE BIGINT",
        "ALTER TABLE playlists ALTER COLUMN user_id TYPE BIGINT",
        "ALTER TABLE downloaded_songs ALTER COLUMN user_id TYPE BIGINT",
        "ALTER TABLE voice_chat_sessions ALTER COLUMN chat_id TYPE BIGINT",
    ]
